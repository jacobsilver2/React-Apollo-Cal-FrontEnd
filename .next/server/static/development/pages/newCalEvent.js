...
var ActsList = styled_components__WEBPACK_IMPORTED_MODULE_3___default.a.div.withConfig({
...
function (_Component) {
  ...
  function CreateEvent() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "update", function (cache, payload) {
      ...
      actsData.acts = actsData.acts.push(payload.data.createEvent.act); // 3. Put the items back
