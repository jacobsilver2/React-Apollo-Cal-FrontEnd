...
})(["text-align:center;display:inline-grid;grid-template-columns:repeat(4,auto);align-items:stretch;justify-content:center;align-content:center;margin:2rem 0;border:1px solid ", ";border-radius:10px;& > *{margin:0;padding:15px 30px;border-right:1px solid ", ";&:last-child{border-right:0;}}a[aria-disabled='true']{color:grey;pointer-events:none;}button{background-color:'#4CAF50';border:1px solid green;color:white;padding:10px 24px;cursor:pointer;float:left;}button:not(:last-child){border-right:none;}.btn-group:after{content:\"\";clear:both;display:table;}button:hover{background-color:'#3e8e41';}"], function (props) {
...
//# sourceMappingURL=acts.js.c92fd32d6e29c06c2e5d.hot-update.js.map