...
function (_Component) {
  ...
  function DeleteEvent() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "update", function (cache, update) {// manually update the cache on the client, so it matches the server
      // 1. Read the items in the cachee
    });
...
//# sourceMappingURL=event.js.5065709f368e5b8c6225.hot-update.js.map