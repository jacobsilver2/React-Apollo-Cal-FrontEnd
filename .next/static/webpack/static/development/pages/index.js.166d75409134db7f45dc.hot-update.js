    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "renderCells", function (events) {
      ...
      while (day <= endDate) {
        for (var i = 0; i < 7; i++) {
          ...
          matchedEvent.length && console.log(matchedEvent);
          var cloneDay = day;
          days.push(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
            ...
            __self: this
          }, formattedDate), console.log(matchedEvent.length), matchedEvent.length && matchedEvent.map(function (e) {
...
//# sourceMappingURL=index.js.166d75409134db7f45dc.hot-update.js.map