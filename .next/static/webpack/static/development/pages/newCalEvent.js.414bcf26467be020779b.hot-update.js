...
function (_Component) {
  ...
  function CreateEvent() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "update", function (cache, payload) {
      ...
      console.log("The payload is ".concat(payload));
      var eventsData = cache.readQuery({
      ...
      eventsData.events = eventsData.events.push(payload.data); // actsData.events = actsData.events.push(payload.data);
...
//# sourceMappingURL=newCalEvent.js.414bcf26467be020779b.hot-update.js.map