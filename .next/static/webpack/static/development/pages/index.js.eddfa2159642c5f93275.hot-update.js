...
/* harmony import */ var _styles_CalendarStyles__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./styles/CalendarStyles */ "./components/styles/CalendarStyles.js");
...
function (_Component) {
  ...
  function Calendar() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "renderDays", function () {
      var dateFormat = 'EEEE';
      var days = [];
      var startDate = Object(date_fns__WEBPACK_IMPORTED_MODULE_2__["startOfWeek"])(_this.state.currentMonth);
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "renderCells", function () {
      ...
      while (day <= endDate) {
        for (var i = 0; i < 7; i++) {
          ...
          days.push(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
            className: "col cell ".concat(!Object(date_fns__WEBPACK_IMPORTED_MODULE_2__["isSameMonth"])(day, monthStart) ? "disabled" : Object(date_fns__WEBPACK_IMPORTED_MODULE_2__["isSameDay"])(day, selectedDate) ? "selected" : ""),
            key: day.toString(),
            __source: {
              fileName: _jsxFileName,
              lineNumber: 71
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "nextMonth", function () {
      _this.setState({
        currentMonth: Object(date_fns__WEBPACK_IMPORTED_MODULE_2__["addMonths"])(_this.state.currentMonth, 1)
      });
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "prevMonth", function () {
      _this.setState({
        currentMonth: Object(date_fns__WEBPACK_IMPORTED_MODULE_2__["subMonths"])(_this.state.currentMonth, 1)
      });
    });
  ...
  _createClass(Calendar, [{
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_styles_CalendarStyles__WEBPACK_IMPORTED_MODULE_3__["StyledCal"], {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 110
        },
...
/***/ "./node_modules/styled-icons/material/ChevronLeft.cjs.js":
false

})
//# sourceMappingURL=index.js.eddfa2159642c5f93275.hot-update.js.map