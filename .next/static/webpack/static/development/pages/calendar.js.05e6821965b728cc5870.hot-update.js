...
function (_Component) {
      ...
      while (day <= endDate) {
        for (var i = 0; i < 7; i++) {
          ...
          days.push(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
            ...
            __self: this
          }, formattedDate), events.length > 0 ? _this.renderEvent(day) : null));
  ...
  _createClass(Calendar, [{
    ...
    value: function renderDays() {
      var dateFormat = 'dddd';
      var days = [];
      var startDate = date_fns__WEBPACK_IMPORTED_MODULE_2__["default"].startOfWeek(this.state.currentMonth);
...
//# sourceMappingURL=calendar.js.05e6821965b728cc5870.hot-update.js.map